...
testCall(function()
    assert(tonumber("12345678e20") > 10e20, tonumber("12345678e20") .. " was not larger than " .. 10e20)
end)

testCall(function()
    assert(tonumber("12345678e20") > 10e20)
end)
...
do
    local v
    v = math.acos(1.01)
    testAssert(isNaN(v), "expected NaN, got " .. v)
    v = math.acos(-1.01)
    testAssert(isNaN(v), "expected NaN, got " .. v)
    v = math.asin(1.01)
    testAssert(isNaN(v), "expected NaN, got " .. v)
